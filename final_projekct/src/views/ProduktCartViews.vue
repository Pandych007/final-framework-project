  ...
  <div class="deteilProductBlock">
    <div class="deteilProductText">
      ...
      <p>
        ...
        everything is fine with displays. Both critics and mass consumersbr
        always praise the quality of the picture provided by the products of the
        Californian brand. And last year's 6.7-inch Retina panels, which had
        ProMotion, swcaused real admiration for many.
      </p>
